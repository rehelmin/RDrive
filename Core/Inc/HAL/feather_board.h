#ifndef __FEATHER_BOARD_H
#define __FEATHER_BOARD_H
...
extern "C" {
    ...
    #define M0_IB_Pin GPIO_PIN_6
    #define M0_IB_GPIO_Port GPIOA
    #define M0_IC_Pin GPIO_PIN_7
    #define M0_IC_GPIO_Port GPIOA
    #define M1_IC_Pin GPIO_PIN_4
    #define M1_IC_GPIO_Port GPIOC
    #define M1_IB_Pin GPIO_PIN_5
    ...
    #define M0_ENC_Z_Pin GPIO_PIN_3
